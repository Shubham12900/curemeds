...
const DepressionBlock = () => {
  return (
    <div className="depression-block">
    <img  className='depression-block-image' src = "./depressed-woman.png" alt='source not found' />
      <div className="depression-block-text" >
          ...
          <Link to = "deprresiondetails"  >Tap to know more</Link> 
      </div>  
    </div>  
  )
}
